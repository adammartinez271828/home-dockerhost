...
# dump the database
docker exec -i con_db_recipes pg_dumpall -U djangouser > backups/upgrade_backup.sql
...
# load my data back
cat backups/upgrade_backup_djangodb.sql | docker exec -i con_db_recipes psql -U djangouser -d djangodb
